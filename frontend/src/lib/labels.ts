...
export const EMPTY = {
  ...
  areasLoadFailed: 'Не удалось загрузить список участков. Повторите попытку.',
  resultLoadFailed: 'Не удалось загрузить результаты участка. Повторите попытку.',
  resultNotReady: 'Результат анализа ещё не опубликован.',
  resultVersionMismatch: 'Данные результата обновляются. Повторите попытку через несколько секунд.',
} as const;
